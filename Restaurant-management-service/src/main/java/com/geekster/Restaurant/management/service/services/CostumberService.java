...
public class CostumberService {
    ...
    public SignUpOutputData signup(SignUpInputData signUpInputData) {
        ...
        Costumber costumber = new Costumber(signUpInputData.getUserEmailId() , encryptedPassword ,
                signUpInputData.getUserFirstName() , signUpInputData.getUserLastName() ,
                signUpInputData.getUserAddress() , signUpInputData.getUserMobileNumber());
